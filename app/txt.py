...
# yaml_dir = "Tensorflow/workspace/data/train"  # Replace with your folder path containing YAML files
# output_dir = "yolo_labels/train"  # Directory to save YOLO TXT files
